...
class BuildExe:
    def __init__(self):
        ...
        #Name of program
        self.project_name = "Shapescape"
 
        #Project url
        self.project_url = "http://globalgamejam.org/2012/shapescape"
        ...
        #Auhor of program
        self.author_name = "Laci Barton, Tyler Pokos, Landon Anker, Griffin Veldhvizen, Richie Derp, Eric Forsting, Random Kohl, Collin Gosmire, Ivan VenOsdel, James Kirk"
        self.author_email = "example@example.com"
        self.copyright = "Copyright (c) 2009 Me."
 
        #Description
        self.project_description = "You start as the beginning of your better; a ravenous, consuming mass in the blackness. Swimming through the sea of darkness, you must gather food to grow or die due to lack of desire. Swallowing polygons of peculiar hues will procure new ways of wandering and consumption, while approaching your prey from different directions will dictate your shape. Chase and consume rare quarry to become the best you can be... but don't bring about your own demise in the process."
